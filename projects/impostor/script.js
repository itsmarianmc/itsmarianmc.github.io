...
function showCard() {
    ...
    cardFront.innerHTML = `<div style="top: 0; position: relative;"><a>${players[current]}</a></div><div style="height: calc(100% - 45px - 45px - 45px)"></div><div style="bottom: 0;position: relative;"><a>↑</a><br><a>Karte aufdecken</a></div>`;
...
function revealCard() {
    ...
    cardBack.innerHTML = isImp
                         ? '<div style="top: 0; position: relative;"><a style="color: #ff0000">Impostor</a></div><div style="height: calc(100% - 45px - 45px - 45px)"></div><div style="bottom: 0;position: relative;"><a>↓</a><br><a>Karte umdrehen</a></div>'
                         : `<div style="top: 0; position: relative;"><a>${word}</a></div><div style="height: calc(100% - 45px - 45px - 45px)"></div><div style="bottom: 0;position: relative;"><a>↓</a><br><a>Karte umdrehen</a></div>`;
